...
The network is divided into **two major domains** representing an enterprise internal network and a service-oriented dual-stack network.
...
<p align="center">
  <img src="Topology Image/Topology.png" alt="Enterprise Network Topology" width="900">
</p>
...
- Implement IPv6 addressing (`2000:12:34::/64`) on right-side routers (R5–R8)
...
- Configure ZBF on **R1** to control:
  - ICMP
  - HTTP / HTTPS
  - DNS
  - FTP
- Deploy IOS IPS on **R5** with stateful inspection
